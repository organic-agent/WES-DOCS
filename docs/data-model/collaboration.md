...
erDiagram
    ...
    USERS |o--o{ COLLAB_PARTICIPANTS : authenticates
...
- 컨셉당 세션은 하나다(`concept_folder_id` UK). 재발급은 기존 세션의 토큰을 교체한다.
- 활성 좋아요는 세션·사진·참여자당 하나다. 참여자·사진·세션의 일치는 서비스에서 검증하며 이 조합 자체에 복합 FK가 있는 것은 아니다.
